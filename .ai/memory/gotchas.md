...
<a id="got-20260721-01"></a>

- **状态**：已废弃
- **范围**：历史 SDD live reviewer campaign；已退出当前维护
- **来源**：迁移前记录：本仓库 commit `94bb0264f83a54d6b5f31af25ebdf433d14f7fc5` 中 `.ai/memory/gotchas.md` 的同名条目；原始对话链接未附。
- **标签**：#skills #eval #sdd #prompt #claude-code
- **核验记录**：2026-09-08：原条目已明确废弃，对应 campaign／Role Prompt Fidelity 机制已退出当前流程；仅保留历史问题及原因。现行规则见 [2026-07-21 Skills 工作流采用 Judgment-First 与有界 Review](decisions.md#dec-20260721-01) 和 [2026-07-21 Skills 不维护持久测试并停止默认模型验证](decisions.md#dec-20260721-02)。

> 历史变更说明（2026-07-21）： 本仓库不再运行或维护 live reviewer campaign，也不再保留 Role Prompt Fidelity 或 scope-hash gate。保留此条仅用于说明历史成本来源；现行规则见 [2026-07-21 Skills 工作流采用 Judgment-First 与有界 Review](decisions.md#dec-20260721-01)。
...
<a id="got-20260721-02"></a>

- **状态**：已废弃
- **范围**：历史 Role Prompt Fidelity 与 integration harness；已退出当前维护
- **来源**：迁移前记录：本仓库 commit `94bb0264f83a54d6b5f31af25ebdf433d14f7fc5` 中 `.ai/memory/gotchas.md` 的同名条目；原始对话链接未附。
- **标签**：#skills #eval #sdd #prompt
- **核验记录**：2026-09-08：原条目已明确废弃，对应 campaign／Role Prompt Fidelity 机制已退出当前流程；仅保留历史问题及原因。现行规则见 [2026-07-21 Skills 工作流采用 Judgment-First 与有界 Review](decisions.md#dec-20260721-01) 和 [2026-07-21 Skills 不维护持久测试并停止默认模型验证](decisions.md#dec-20260721-02)。

> 历史变更说明（2026-07-21）： 对应测试资产和产品侧 Role Prompt Fidelity 均已删除。Delegated brief 只需语义完整，不再冻结模板字序、占位符实例化方式或工具顺序；现行规则见 [2026-07-21 Skills 工作流采用 Judgment-First 与有界 Review](decisions.md#dec-20260721-01)。
...
<a id="got-20260521-01"></a>

- **状态**：待核验
- **范围**：仅限历史 obra/superpowers 上游贡献要求；当前适用性待核验
- **来源**：迁移前记录：本仓库 commit `94bb0264f83a54d6b5f31af25ebdf433d14f7fc5` 中 `.ai/memory/gotchas.md` 的同名条目；原始对话链接未附。
- **标签**：#upstream-pr #skills #eval
- **核验记录**：2026-09-08：原记录引用的上游 PR 模板不在本仓库，当前上游准入要求未核验；本条不作为本项目 Git 操作规则。个人 fork 的定位见 [2026-05-21 个人 fork 不面向上游贡献](decisions.md#dec-20260521-03)。
