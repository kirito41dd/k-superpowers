...
- `type-driven-verification`：采用类型优先、风险驱动验证，并单一拥有核心代码说明合同。Direct/Inline 修改非自解释的核心结构、函数或抽象前加载该 owner；注释语言跟随项目和邻近文件。
...
```text
k-superpowers@k-superpowers-dev  installed, enabled  5.4.4
```
