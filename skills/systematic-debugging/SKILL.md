...
1. **Choose Verification Before Fixing**
   ...
   - Use `superpowers:test-driven-development` for type-first verification guidance
...
**Related skills:**
- **superpowers:test-driven-development** - For type-first verification guidance (Phase 4, Step 1)
